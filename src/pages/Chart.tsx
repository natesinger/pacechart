...
export default function PaceChart() {
  ...
  const toggleCol = (c: number) =>
    setHL((p) => ({ r: p.r, c: p.c === c ? null : c }));
  const toggleRow = (r: number) =>
    setHL((p) => ({ r: p.r === r ? null : r, c: p.c }));
  ...
  return (
    <div className="Chart h-[100dvh] flex flex-col overflow-hidden text-zinc-100 bg-zinc-900">
      ...
      <div
        ref={headerRef}
        className={`sticky top-0 ${DEFAULT_BG} border-b border-zinc-700 z-30 overflow-hidden`}
      >
          ...
          <thead>
            <tr>
              <th
                style={cellStyle}
                className={cx(
                  `box-border border border-zinc-700 sticky left-0 z-30 ${HEADER_BG}`,
                  TOP_ROW_BORDER,
                  LEFT_COL_BORDER
                )}
              >
                <div className="flex flex-row items-center justify-center gap-2">
                  <a href="/" className="p-1 hover:text-blue-300">
                ...
                {dists.map((d, c) => {
                  ...
                  return (
                    <td
                      ...
                      onMouseEnter={() => !isDragging && setHoveredCell([r, c])}
                      className={cx(
      ...
      {/* ✨ SETTINGS MODAL: Entire component rewritten for better styling and layout */}
        ...
        <Dialog as="div" className="relative z-50" onClose={() => setOpen(false)}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              >
                <Dialog.Panel className="w-full max-w-sm transform overflow-hidden rounded-2xl bg-zinc-900/95 p-6 text-left align-middle shadow-2xl ring-1 ring-white/10 transition-all">
                  <Dialog.Title
                    as="h3"
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-zinc-400">
                      Customize the visualization below.
                    </p>
                  </div>
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="flex items-center justify-between">
                      <label htmlFor="unit-select" className="text-sm text-zinc-300">
                        Units
                      </label>
                      <select
                        id="unit-select"
                        ...
                        className="w-36 rounded-md border-white/10 bg-white/5 py-1.5 px-3 text-sm/6 text-zinc-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-blue-500"
                      >
                    ...
                    <div className="flex items-center justify-between">
                      <label htmlFor="pace-select" className="text-sm text-zinc-300">
                        Pace Interval
                      </label>
                      <select
                        id="pace-select"
                  ...
                  {/* actions */}
                  <div className="mt-8 pt-5 border-t border-zinc-700/50 flex justify-between items-center">
                    <div className="flex gap-2">
                        <button
                          onClick={clearHL}
                          className="inline-flex justify-center rounded-md bg-zinc-700 px-3 py-2 text-xs font-semibold text-zinc-100 shadow-sm hover:bg-zinc-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900 cursor-pointer"
                        >
                          Clear Highlight
                        </button>
                         <button
                    ...
                    <button
                      ...
                      className="inline-flex justify-center rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900 cursor-pointer"
                    >
                      Done
                    </button>
                  </div>
